...
declare global { interface Window { __TUNEDIN_ENABLE_CONSOLE?: boolean } }
if (typeof window !== 'undefined' && !ENABLE_CONSOLE && !window.__TUNEDIN_ENABLE_CONSOLE) {
  try {
    const _noop = function(){} as any;
    // @ts-ignore
    console.log = _noop; console.info = _noop; console.warn = _noop; console.error = _noop; console.debug = _noop; console.trace = _noop; console.group = _noop; console.groupCollapsed = _noop; console.groupEnd = _noop;
  } catch {}
}
